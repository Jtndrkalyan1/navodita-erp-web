...
export default function PaymentMadeListPage() {
  ...
  const fetchPayments = useCallback(async () => {
    ...
    try {
      ...
      try {
        const statsRes = await paymentMadeApi.stats({
          search: debouncedSearch || undefined,
        });
  ...
  const handleDeleteConfirm = async () => {
    setDeleting(true);
    try {
      await paymentMadeApi.remove(deleteConfirm.id);
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-[#333]">Payments Made</h1>
                ...
                payments.map((payment) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-[#333]">
                      {payment.vendor_name || payment.vendor?.display_name || '--'}
                    </td>
